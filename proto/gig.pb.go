...
func (x *CreateGigReq) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
type EmtpyGigRes struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *EmtpyGigRes) Reset() {
	*x = EmtpyGigRes{}
	if protoimpl.UnsafeEnabled {
...
func (x *EmtpyGigRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EmtpyGigRes) ProtoMessage() {}

func (x *EmtpyGigRes) ProtoReflect() protoreflect.Message {
	mi := &file_gig_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EmtpyGigRes.ProtoReflect.Descriptor instead.
func (*EmtpyGigRes) Descriptor() ([]byte, []int) {
...
var file_gig_proto_rawDesc = []byte{
	...
	0x22, 0xfa, 0x01, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x47, 0x69, 0x67, 0x52, 0x65,
	...
	0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x0d, 0x0a,
	0x0b, 0x45, 0x6d, 0x74, 0x70, 0x79, 0x47, 0x69, 0x67, 0x52, 0x65, 0x73, 0x32, 0x3e, 0x0a, 0x0a,
	0x47, 0x69, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x30, 0x0a, 0x09, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x47, 0x69, 0x67, 0x12, 0x11, 0x2e, 0x67, 0x69, 0x67, 0x2e, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x47, 0x69, 0x67, 0x52, 0x65, 0x71, 0x1a, 0x10, 0x2e, 0x67, 0x69, 0x67,
	0x2e, 0x45, 0x6d, 0x74, 0x70, 0x79, 0x47, 0x69, 0x67, 0x52, 0x65, 0x73, 0x42, 0x09, 0x5a, 0x07,
...
var file_gig_proto_goTypes = []any{
	...
	(*EmtpyGigRes)(nil),  // 1: gig.EmtpyGigRes
}
var file_gig_proto_depIdxs = []int32{
	0, // 0: gig.GigService.CreateGig:input_type -> gig.CreateGigReq
	1, // 1: gig.GigService.CreateGig:output_type -> gig.EmtpyGigRes

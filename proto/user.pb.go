...
var file_user_proto_rawDesc = []byte{
	...
	0x6f, 0x32, 0xdb, 0x03, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x42,
...
var file_user_proto_goTypes = []any{
	...
	(*FreeAddSkillsReq)(nil), // 12: user.FreeAddSkillsReq
	(*UpdateProfileReq)(nil), // 13: user.UpdateProfileReq
	(*UpdatePP_Req)(nil),     // 14: user.UpdatePP_Req
	nil,                      // 15: user.CommonRes.DataEntry
}
var file_user_proto_depIdxs = []int32{
	15, // 0: user.CommonRes.data:type_name -> user.CommonRes.DataEntry
	7,  // 1: user.CommonRes.DataEntry.value:type_name -> user.AnyValue
	0,  // 2: user.UserService.UserSignup:input_type -> user.SignupReq
	2,  // 3: user.UserService.VerifyingEmail:input_type -> user.VerifyReq
	4,  // 4: user.UserService.Login:input_type -> user.LoginReq
	8,  // 5: user.UserService.AdminLogin:input_type -> user.AdLoginReq
	9,  // 6: user.UserService.AddCategory:input_type -> user.CategoryReq
	10, // 7: user.UserService.AddSkill:input_type -> user.AddSkillReq
	13, // 8: user.UserService.UpdateBio:input_type -> user.UpdateProfileReq
	14, // 9: user.UserService.UpdateProfilePic:input_type -> user.UpdatePP_Req
	12, // 10: user.UserService.FreelacerAddSkill:input_type -> user.FreeAddSkillsReq
	1,  // 11: user.UserService.UserSignup:output_type -> user.SignupRes
	3,  // 12: user.UserService.VerifyingEmail:output_type -> user.VerifyRes
	5,  // 13: user.UserService.Login:output_type -> user.LoginRes
	6,  // 14: user.UserService.AdminLogin:output_type -> user.CommonRes
	6,  // 15: user.UserService.AddCategory:output_type -> user.CommonRes
	6,  // 16: user.UserService.AddSkill:output_type -> user.CommonRes
	6,  // 17: user.UserService.UpdateBio:output_type -> user.CommonRes
	6,  // 18: user.UserService.UpdateProfilePic:output_type -> user.CommonRes
	6,  // 19: user.UserService.FreelacerAddSkill:output_type -> user.CommonRes

...
var file_user_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0xfe, 0x01, 0x0a, 0x0b, 0x55,
	...
	0x72, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x42, 0x09, 0x5a, 0x07, 0x2e,
...
var file_user_proto_goTypes = []any{
	...
	nil,                 // 10: user.CommonRes.DataEntry
}
var file_user_proto_depIdxs = []int32{
	10, // 0: user.CommonRes.data:type_name -> user.CommonRes.DataEntry
	...
	1,  // 7: user.UserService.UserSignup:output_type -> user.SignupRes
	3,  // 8: user.UserService.VerifyingEmail:output_type -> user.VerifyRes
	5,  // 9: user.UserService.Login:output_type -> user.LoginRes
	6,  // 10: user.UserService.AdminLogin:output_type -> user.CommonRes
	6,  // 11: user.UserService.AddCategory:output_type -> user.CommonRes
